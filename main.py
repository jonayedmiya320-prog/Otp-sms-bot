...
class OTPMonitorBot:
    ...
    def fetch_sms_data(self):
        ...
        headers = {
            ...
            'User-Agent': 'Mozilla/5.0 (Linux; Android 16; 23129RN51X Build/BP2A.250605.031.A3) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/147.0.7727.138 Mobile Safari/537.36',
...
async def main():
    TELEGRAM_BOT_TOKEN = "8513071962:AAEuk7UOeKn1eV8rzCuB9B7giHbkAIudNGM"
    GROUP_CHAT_ID = "-1003247504066"
    SESSION_COOKIE = "762a3d8605091bb8bcaa118d69db9296"
    TARGET_HOST = "139.99.9.4"
    CSSTR_PARAM = "3acc348a709215e69664db0772be8876"
    TIMESTAMP_PARAM = "1778257312613"
